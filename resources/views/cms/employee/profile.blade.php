                    ...
                    <div class="header">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <center>
                                    <a href="/cms/employees/{{ $employee->getFirstAttribute('samaccountname') }}/update" type="button" class="btn bg-green waves-effect" style="display: inline-block;"><i class="material-icons">edit</i><span>UPDATE EMPLOYEE INFO</span></a>
