            ...
            <div class="header">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <center>
                            <a href="/cms/employees/{{ $user->getFirstAttribute('samaccountname') }}" type="button" class="btn bg-blue waves-effect" style="display: inline-block;"><i class="material-icons">list</i><span>VIEW EMPLOYEE INFO</span></a>
                        </center>
                    </div>
                </div>
            </div>
